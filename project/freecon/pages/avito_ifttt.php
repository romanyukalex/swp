...
$file = $_SERVER['DOCUMENT_ROOT'].'/project/freecon/files/Avito.txt';
	// Открываем файл для получения существующего содержимого
	$current = file_get_contents($file);


	#оповестим себя о приходе письма с авито
	$subject="Новое подтверждение поиска на авито";
...
foreach($_POST as $key => $empty) { 
	...
	$message.=$current."<br>Key=".$key." empty= ".$empty;
