...
$logfile="/home/a/aromanuq/popwebstudio/public_html/project/adigeya/app.log";// Path to site log file
$ap_logfile="/home/a/aromanuq/popwebstudio/public_html/project/adigeya/adminpanel.log";// Path to adminpanel log file with 666 permissions
$cron_logfile=$fullpath."project/$projectname/cron.log";// Path to log file for CRON tasks
# Data for connect to mysql
$databasename="aromanuq_squest";
$dbadmin_login="aromanuq_squest";
$dbadmin_pass="z;G!1RoJM&?U";
