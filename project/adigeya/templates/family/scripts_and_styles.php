<? 
 ...
 <!-- Le styles -->
        <link href="project/templates/egypt/files/css_defa.css" media="" rel="stylesheet" type="text/css">
<link href="project/templates/egypt/files/madagask.css" media="screen" rel="stylesheet" type="text/css">
        <!-- Scripts -->
        <script type="text/javascript" src="project/templates/egypt/files/js_defau.js"></script>
