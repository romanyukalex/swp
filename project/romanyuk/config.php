...
$logfile="/home/a/aromanuq/popwebstudio/public_html/project/romanyuk/app.log";// Path to site log file
$ap_logfile="/home/a/aromanuq/popwebstudio/public_html/project/romanyuk/adminpanel.log";// Path to adminpanel log file with 666 permissions
$cron_logfile=$fullpath."project/$projectname/cron.log";// Path to log file for CRON tasks
# Data for connect to mysql
$databasename="aromanuq_romanuk";
$dbadmin_login="aromanuq_romanuk";
$dbadmin_pass="!p}e0942";
