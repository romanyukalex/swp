           	...
           	<div class="container box_1620">
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img src="/project/romanyuk/templates/metme/img/personal.jpg" alt="">
							</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <script src="/project/romanyuk/templates/metme/js/jquery-3.3.1.min.js"></script>
        <script src="/project/romanyuk/templates/metme/js/popper.js"></script>
        <script src="/project/romanyuk/templates/metme/js/bootstrap.min.js"></script>
        <script src="/project/romanyuk/templates/metme/js/stellar.js"></script>
        <script src="/project/romanyuk/templates/metme/vendors/lightbox/simpleLightbox.min.js"></script>
        <script src="/project/romanyuk/templates/metme/vendors/nice-select/js/jquery.nice-select.min.js"></script>
        <script src="/project/romanyuk/templates/metme/vendors/isotope/imagesloaded.pkgd.min.js"></script>
        <script src="/project/romanyuk/templates/metme/vendors/isotope/isotope.pkgd.min.js"></script>
        <script src="/project/romanyuk/templates/metme/vendors/owl-carousel/owl.carousel.min.js"></script>
        <script src="/project/romanyuk/templates/metme/vendors/popup/jquery.magnific-popup.min.js"></script>
        <script src="/project/romanyuk/templates/metme/js/jquery.ajaxchimp.min.js"></script>
        <script src="/project/romanyuk/templates/metme/vendors/counter-up/jquery.waypoints.min.js"></script>
        <script src="/project/romanyuk/templates/metme/vendors/counter-up/jquery.counterup.min.js"></script>
        <script src="/project/romanyuk/templates/metme/js/mail-script.js"></script>
        <script src="/project/romanyuk/templates/metme/js/theme.js"></script><?
