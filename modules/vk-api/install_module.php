...
if ($moduleinstalled['$modulename']!=='y' and $nitka=="1"){ #Требуется инсталляция
	...
	# $module_id - id модуля
	$put_siteconfig=mysql_query("INSERT INTO `$tableprefix-siteconfig` (`id`, `value`, `vartype`, `describe`, `systemparamname`, `formmaxlegth`, `varpossible`, `showtositeadmin`, `example`, `depend`, `maybeempty`, `module_id`, `company_id`) 
	VALUES 
	(NULL, NULL, '1', 'VK API ID', 'vkapi_api_id', NULL, NULL, '1', NULL, 'system', '1', NULL, NULL),
	(NULL, NULL, '1', 'VK API Secret Key', 'vkapi_secret_key', NULL, NULL, '1', NULL, 'system', '1', NULL, NULL),
	(NULL, '', '1', 'VK API Access Token', 'vkapi_access_token', NULL, NULL, '1', NULL, 'system', '1', NULL, NULL)
	;");
	/*
