...
if ($moduleinstalled["$modulename"]!=='y' and $nitka=='1'){ #Требуется инсталляция
	...
	$DBdata['Adding siteconfig settings']="INSERT INTO `$tableprefix-siteconfig` (`id`, `value`, `vartype`, `describe`, `systemparamname`, `inmemory`, `formmaxlegth`, `varpossible`, `showtositeadmin`, `example`, `depend`, `maybeempty`, `module_id`) VALUES (NULL, '3wbjvs3l1wtzhr4ka8sq8fwxqmkg74z7s2iycbck8qxjg67e', '1', 'API key for tinyMCE', 'tinymceapikey', 'ondemand', NULL, NULL, '1', NULL, 'system', '1','$module_id');";
